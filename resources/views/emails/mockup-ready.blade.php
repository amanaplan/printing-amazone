...
<table class="container" align="center" border="0" cellpadding="0" cellspacing="0" width="600">
    <tbody>
    <tr bgcolor="ed8f01"><td height="15"></td></tr>
    ...
    <tr bgcolor="ed8f01">
        <td align="center">
            <table class="container-middle" align="center" border="0" cellpadding="0" cellspacing="0" width="560">
                <tbody><tr>
                    <td>
                        <span style="color: #ffffff;"><strong>Order ID:</strong>  {{ $order_token }}</span>
    ...
    <tr bgcolor="ed8f01"><td height="10"></td></tr>
...
<!--Header-->
<tbody><tr style="background-color: #54380e;"><td height="20"></td></tr>

<tr style="background-color: #54380e;">
    <td>
...
<tr style="background-color: #54380e;"><td height="20"></td></tr>
<!-- end header -->
            ...
            <tr>
                <td>
                    <table class="mainContent" align="center" border="0" cellpadding="0" cellspacing="0" width="528">
                        ...
                        <tr>
                            <td style="padding:0 0 3px; font:bold 22px Arial, Helvetica, sans-serif; color:#323a46;">The mock-up ( digital proof ) for the artwork provided by you is ready</td>
                        </tr>
                                ...
                                <td style="padding:30 0 17px;">
                                    <table cellspacing="0" cellpadding="0">
                                        <tbody>
                                            ...
                                            <tr><td>&nbsp;</td></tr>
                                            <tr>
                                                <td class="button-outlook" style="border-radius:4px; font:bold 18px/20px Arial, Helvetica, sans-serif; color:#fff;" bgcolor="#e85c41" align="center">
                                                    <a href="{{ $url }}" style="text-decoration:none;background-color: rgb(0, 124, 193); color:#fff; display:block; padding:10px 16px 10px;">Review Your Mockup</a>
                                                </td>
                                            </tr>
                                    </tbody></table>
                                </td>
...
<table class="container" border="0" cellpadding="0" cellspacing="0" width="600">
    ...
    <tr bgcolor="ed8f01">
        <td  style="color: #fff; font-size: 10px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" align="center">
            ...
            printingamazon &copy; Copyright {{date('Y', time())}} . All Rights Reserved

        </td>
    </tr>

    <tr>
        <td bgcolor="ed8f01" height="14"></td>
    </tr>
    </tbody></table>
<!-- end footer-->
</td>
