        ...
        <div class="col-md-12">
            <div class="panel panel-card margin-b-30">
                ...
                <div class="panel-body">
                    <form action="{{ url('/admin/request/special-product/edit/'.$product->id) }}" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" disabled="disabled" class="form-control" value="{{ $product->product_name }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" disabled="disabled" class="form-control" value="{{ $product->product_slug }}">
                            </div>
                        </div>
