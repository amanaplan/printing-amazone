...
{{-- title of the page --}}
@section('pagetitle')
    available quantity group 2 presets for {{ $product_name }}
@stop
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title">
                <div class="row">
                    <h4 class="pull-left">Quantity rules group- 2  <code class="well well-sm">% discount rate applies every extra {qty} from {qty} to {qty}</code></h4>
            ...
            <div class="panel panel-card recent-activites">
                ...
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <div class="btn-group">
                            <a href="{{ url('/admin/product/presets/qty-rule-sec/'.$product_id) }}" class="btn btn-success btn-rounded btn-xs">Add New Preset</a>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="tablesaw" data-tablesaw-sortable data-tablesaw-sortable-switch>
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">For Every Extra Order</th>
                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2">From Order Qty.</th>
                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="3">To Order Qty.</th>
                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">Discount %</th>
