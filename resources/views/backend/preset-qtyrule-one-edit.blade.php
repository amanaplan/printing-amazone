                ...
                <div class="panel-body">
                    <form action="{{ url('/admin/product/presets/qty-rule-first/edit-rq/'.$preset_id.'/'.$product_id) }}" method="post" class="form-horizontal">
                        ...
                        <div class="input-group m-b col-sm-10 {{ $errors->has('qty_frm') ? ' has-error' : '' }}"> 
                            <input type="number" name="qty_frm" min="1" class="form-control" value="{{ $preset->order_qty_frm }}"> 
                        ...
                        <div class="input-group m-b col-sm-10 {{ $errors->has('qty_to') ? ' has-error' : '' }}"> 
                            <input type="number" name="qty_to" min="1" class="form-control" value="{{ $preset->order_qty_to }}"> 
