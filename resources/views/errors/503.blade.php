...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/frontend/css/robot_page.css') }}">
<script src="{{ asset('assets/frontend/js/snap.svg-min.js') }}" type="text/javascript"></script>
...
<body>
	...
	<div>
		<div class="robotpage-top-half">
			<div id="robot_holder">
				...
				<svg id="brokebotSVG" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
					...
					<text id="errorCodeTxt" transform="matrix(1 0 0 1 6.7231 240.0011)" class="error_code" >503</text>
					<g id="robotHead">
		...
		<div class="robotpage-bottom-half">
			...
			<div>
				<p id="robot-text">Some Server Error Occurred</p>
				<p style="color:#fff;">Why don't you try one of these pages instead?</p>
				<div class="robot-buttons">
					<a class="robot-buttons" href="{{ url('/') }}">Home</a> 
					<a class="robot-buttons" href="{{ url('/contact') }}">Contact</a>
				</div>
			</div>
