    ...
    public function build()
    {
        return $this->from('orders@printingamazon.com.au', config('app.name').' Order')
                    ...
                    ->with([
                        ...
                        'state'         => base64_decode($this->order_info->get('state')),
                        'city'          => base64_decode($this->order_info->get('city')),
                        'zipcode'       => base64_decode($this->order_info->get('zipcode')),
                        'street'        => base64_decode($this->order_info->get('street')),
                        ...
                        'name'          => base64_decode($this->personal_info->get('name')),
                        'email'         => base64_decode($this->personal_info->get('email')),
                        'phone'         => base64_decode($this->personal_info->get('phone')),
                        'company'       => base64_decode($this->personal_info->get('company')),
