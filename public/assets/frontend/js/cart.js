...
$(document).ready(function () {
	$("span.remove-item").on('click', function () {
		...
		_axios2.default.delete(_boot2.default + 'cart/remove-product', {
			params: { item: item }
		}).then(function (response) {
			if (response.data.count == 0) {
				$("div#cart").html('\n\t\t    \t\t<div class="feature">\n\t\t\t\t\t\t<div class="container">\n\t\t\t\t\t\t\t<div class="row" style="height: 400px">\n\t\t\t\t\t\t\t\t<h2>Your cart is empty</h2>\n\t\t\t\t\t\t\t\t<p class="subtitle">You may want to add some <a href="' + _boot2.default + 'sticker">product</a> in your cart.</p>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t    \t');
	...
	$(".clr-shopping").click(function (e) {
		...
		_axios2.default.delete(_boot2.default + 'cart/empty-cart', {}).then(function (response) {
			$("div#cart").html('\n\t    \t\t<div class="feature">\n\t\t\t\t\t<div class="container">\n\t\t\t\t\t\t<div class="row" style="height: 400px">\n\t\t\t\t\t\t\t<h2>Your cart is empty</h2>\n\t\t\t\t\t\t\t<p class="subtitle">You may want to add some <a href="' + _boot2.default + 'sticker">product</a> in your cart.</p>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t    \t');
...
function updateProductPrice(cartId, qtyBox) {
	...
	_axios2.default.post(_boot2.default + 'cart/update-quantity', {
		cartid: cartId,
		qty: currQty
	}).then(function (response) {
