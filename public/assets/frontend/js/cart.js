	...
	$("span.remove-item").on('click', function () {
		...
		__WEBPACK_IMPORTED_MODULE_0_axios___default.a.delete(__WEBPACK_IMPORTED_MODULE_1__boot_js__["a" /* default */] + 'cart/remove-product', {
			...
			if (response.data.count == 0) {
				$("div#cart").html('\n\t\t    \t\t<div class="feature">\n\t\t\t\t\t\t<div class="container">\n\t\t\t\t\t\t\t<div class="row" style="height: 400px">\n\t\t\t\t\t\t\t\t<h2>Your cart is empty</h2>\n\t\t\t\t\t\t\t\t<p class="subtitle">You may want to add some <a href="' + __WEBPACK_IMPORTED_MODULE_1__boot_js__["a" /* default */] + '">product</a> in your cart.</p>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t    \t');
...
function disableQtyDropdown(qtyBox) {
