...
(function () {
    ...
    document.getElementById('upload').onchange = function () {
        ...
        _axios2.default.post(_boot2.default + 'upload-artwork/process-upload', data, config).then(function (res) {
            resetAnimation();
...
$(document).ready(function () {
    $("button#rem-artwork").click(function () {
        ...
        _axios2.default.post(_boot2.default + 'upload-artwork/remove-current', {
            removecurrent: 1
        }).then(function (res) {
