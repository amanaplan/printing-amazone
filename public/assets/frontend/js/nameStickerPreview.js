...
$("select[name='type']").change(function () {
	...
	_axios2.default.get(_boot2.default + 'product/name-sticker/get-preview?artwork=' + stickerType).then(function (response) {
		$("img#sticker-preview").attr("src", _boot2.default + 'assets/images/products/' + response.data);
		...
		(0, _main2.default)('Invalid Sticker Type! try after some time', 'Dismiss');
	});
});
